...
public class Popularmovie extends RecyclerView.Adapter<Popularmovie.Movieview> {
    ...
    public Popularmovie(Context context, ArrayList<MovieDetail> details, Movieclicklistener listener) {
        mContext = context;
